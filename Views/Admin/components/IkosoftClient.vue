            ...
            <div class="section-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a :href="exporUrl" target="_blank" class="btn pull-right mr10 btn-default-bright"><i class="fa fa-file-excel-o" aria-hidden="true"></i> Exporter tout les actifs</a>
                    </div><!--end .col -->
                </div>
        ...
        methods: {
            ...
            callback(nRow, aData, iDisplayIndex, iDisplayIndexFull){
                ...
                if (aData['website'] == null) {
                    ...
                    $('td:eq(7)', nRow).html('<a title="Voir le site" class="btn btn-default-bright" target="_blank" href="' + website + '"><i class="fa fa-eye" aria-hidden="true"></i></a>');
                }
            },
